  ...
  return (
    <View style={style.profileContainer}>
      ...
      <Modal visible={showModal}>
        <View><Text >Modal Add Subject</Text>
          <TextInput  placeholder="Name" onChangeText={(text) => setName(text)} />
          <TextInput  placeholder="Identity" onChangeText={(text) => setIdentity(text)} />
          <Picker mode="dropdown"  selectedValue={classNameSetter.toString()}  onValueChange={(itemValue, index) => {
